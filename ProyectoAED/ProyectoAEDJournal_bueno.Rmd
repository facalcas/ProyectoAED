...
Con los datos consolidados, se realiza la explicación de las variables con las que se cuenta para el análisis, y diversas características presentes en cada uno de los datasets.
...
MSE_evolucion %>% 
  ggplot(aes(x=Año, y=Total_suicidios)) + geom_point() + geom_line(group=1)
```
```{r}
#Quitamos totales
MSE_sin_totales <- MSE %>% 

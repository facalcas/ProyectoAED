...
```{r grafico-defunciones a lo largo del tiempo, echo=FALSE, out.width="85%"}
...
```{r grafico lineas 2020, echo=FALSE, message=FALSE, warning=FALSE, out.width="85%"}
MSE_evolucion <-MSE %>% 
  filter(`Mes de defunción`=="Todos los meses",
         Sexo=="Ambos sexos",
         Edad=="Todas las edades")
...
```{r box por meses MSE, echo=FALSE, message=FALSE, warning=FALSE, out.width="85%"}

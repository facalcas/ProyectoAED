 ...
 **Agregar explicación de trabajo que se hizo para importación de población**
...
```
```{r evolucion por sexo, echo=FALSE, out.width="85%"}
...
**Agregar explicación gráficos por sexo y test realizado**
...
```{r grafico tasa suicidio por nacionalidad, echo=FALSE, out.width="85%"}
...
**Agregar explicación de resultados de tasa por nacionalidad**

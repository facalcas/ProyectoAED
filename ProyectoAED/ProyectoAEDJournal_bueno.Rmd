...
**Agregar explicación resultados de heatmap por edad**

```{r mapas de suicidios por CA, echo=FALSE}
...
**Agregar explicación de Total de número de suicidios por CA**

```{r mapas suicidio por CA cada 100k, echo=FALSE}
ccaa <- esp_get_ccaa(year = "2021") %>% st_as_sf()
...
>>>>>>> c2a5597189a4145060701427c7a747ceb611bbbb
# Conclusion
